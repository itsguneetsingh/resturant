...
const Menu = () => {
  ...
  const starters = [
    {
      ...
      itemDescription: 'Quinoa and cheddar croquettas with aji rocotto & pineapple salsa (v)',
      itemPrice: '£4.95'
    },
    {
  ...
  const mainCourse = [
    {
      ...
      itemDescription: 'Sea bass ceviche with aji limo tiger’s milk, sweet potato purée, choclo corn, red onion, coriander & plantain (gf)',
      itemPrice: '£8.95'
    },
    {
      itemHeading: 'TIRADITO CALLAO',
      itemDescription: 'Cobia tiradito with coriander tiger’s milk, black tobika, crème fraiche & sweet potato crunchies',
      itemPrice: '£8.95'
    }
  ];
  ...
  const sides = [
    ...
    },
    {
      ...
      itemDescription: 'SSweet potato fries with aji rocotto mayonnaise (v)',
      itemPrice: '£3.95'
    },
  ];
  ...
  return (
    <div className='menu-background'>
      <div className='menu-top-group'>
        ...
        <button className='community-button' id='menu-button'>KNOW MORE</button>
      </div>
